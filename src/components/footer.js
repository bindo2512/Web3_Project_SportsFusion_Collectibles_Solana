                        ...
                        <div className="footer-list">
                            ...
                            <ul>
                                ...
                                <li className="footer-list-item">
                                    ...
                                    <a href="mailto:metalink@nft.com" className="footer-link">sportfusion@nft.com</a>
                                </li>
                                ...
                                <li className="footer-list-item">
                                    ...
                                    <a href="tel:+111 234-567-891" className="footer-link">+111 234-567-891</a>
                                </li>
                ...
                <div className="footer-bottom">
                    <div className="container">
                        ...
                        <p className="body-md text-center copyright">
                            &copy; 2024 Solana Web3 App - <span className="span">FPT Polytechnic</span>- Group 16
                        </p>
